pipeline {
    ...
    environment {
        ...
        SONAR_HOST_URL = 'http://18.189.168.243:9000'  // Ensure your SonarQube server URL is correct
        SONARQUBE_AUTH_TOKEN = 'squ_c95f2edcb05867250d239028b6261ec68c12bae2' // Use Jenkins credentials for the SonarQube token
    }
    stages {
        ...
        // This is the updated SonarQube Backend Analysis stage
                ...
                dir(BACKEND_DIR) {
                    script {
                        ...
                        withSonarQubeEnv('SonarQube') { 
                            ...
                            // Run SonarQube analysis on the backend project
